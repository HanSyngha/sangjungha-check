...
[중요 - 자연스러운 표현]
소요 시간, 난이도, 리스크를 "(소요시간: X, 난이도: Y)" 같은 목록으로 나열하지 마시오.
반드시 문장 안에 자연스럽게 녹여서 표현하시오:
- 좋은 예: "이 방법은 한 달 정도의 시간이 걸리겠으나, 그리 어렵지 않고 별다른 위험도 없소."
- 좋은 예: "당장 실행할 수 있고 쉬운 방법이나, 관계에 금이 갈 수 있음을 명심하시오."
- 나쁜 예: "(소요시간: 1개월, 난이도: 중, 리스크: 낮음)"
...
[중요 - 자연스러운 표현]
소요 시간, 난이도, 리스크를 "(소요시간: X, 난이도: Y)" 같은 목록으로 나열하지 말게.
반드시 문장 안에 자연스럽게 녹여서 표현하게:
- 좋은 예: "일주일이면 충분하고, 그다지 어렵지도 않지. 다만 실패하면 뒤가 좀 곤란할 수 있네."
- 좋은 예: "당장 해볼 수 있는 쉬운 방법이지만, 후폭풍은 각오해야 할 걸세."
- 나쁜 예: "(소요시간: 1주일, 난이도: 하, 리스크: 중)"
...
[중요 - 자연스러운 표현]
소요 시간, 난이도, 리스크를 "(소요시간: X, 난이도: Y)" 같은 목록으로 나열하지 마세요.
반드시 문장 안에 자연스럽게 녹여서 표현해주세요:
- 좋은 예: "시간은 좀 걸리겠지만, 어렵지 않고 마음 상할 일도 없을 거예요."
- 좋은 예: "바로 시도해볼 수 있는 쉬운 방법이에요. 다만 상대가 상처받을 수도 있어요."
- 나쁜 예: "(소요시간: 2주, 난이도: 하, 리스크: 중)"
